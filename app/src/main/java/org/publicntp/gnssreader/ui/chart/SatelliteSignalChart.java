...
public class SatelliteSignalChart extends Chart<SatelliteData> {
    ...
    public SatelliteSignalChart(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SatelliteSignalChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SatelliteSignalChart(Context context) {
        super(context);
    }
...
//        setHighlighter(new ChartHighlighter(this));
        ...
        mRenderer = new SatelliteSignalRenderer(this, mAnimator, mViewPortHandler);
...
//                .RIGHT));
    ...
    public void getBarBounds(BarEntry e, RectF outputRect) {
        ...
        ISatelliteDataSet set = mData.getDataSetForEntry(e);
        ...
        float barWidth = 4.0f; // mData.getBarWidth();
...
//    @Override
//    public SatelliteData getBarData() {
//        return mData;
//    }
