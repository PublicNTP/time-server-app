package org.app.timeserver.service.ntp;
 ...
 * format).
 * 
 * However, the contructor org.app.timeserver.service.ntp.NtpMessage(byte[]) and the method toByteArray()
 ...
 * byte[] buf = new org.app.timeserver.service.ntp.NtpMessage().toByteArray();
 ...
 * 
 * Number format conversion code in org.app.timeserver.service.ntp.NtpMessage(byte[] array) and toByteArray()
...
public class NtpMessageJ2ME
{
	...
	/**
	 * Constructs a new org.app.timeserver.service.ntp.NtpMessage from an array of bytes.
	 */
	...
	/**
	 * Constructs a new org.app.timeserver.service.ntp.NtpMessage in client -> server mode, and sets the
	...
	/**
	 * Returns a string representation of a org.app.timeserver.service.ntp.NtpMessage
	 */
	public String toString()
	{
            String strAux = "Leap indicator: " + leapIndicator + "\r\n" + 
 			    "Version: " + version + "\r\n" +
   			    "Mode: " + mode + "\r\n" +
                            "Stratum: " + stratum + "\r\n" +
                            "Poll: " + pollInterval + "\r\n" +
	...
	public static double decodeTimestamp(byte[] array, int pointer)
	{
		...
		{
                    p = _pow(2, (3-i)*8);
                    s = unsignedByteToShort(array[pointer+i]);
                    r +=  s * p;
		}
	...
	public static void encodeTimestamp(byte[] array, int pointer, double timestamp)
	{
		...
		array[7] = (byte) (rd.nextDouble()*255.0);                               
	}
	...
	public static String referenceIdentifierToString(byte[] ref, short stratum, byte version)
	{
        ...
        /**
         * Reimplement of the Pow() 
         */
        public static double _pow(double a, double b)
        {
            double dAux;
            int count; 
